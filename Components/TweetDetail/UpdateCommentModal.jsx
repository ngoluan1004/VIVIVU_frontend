...
export default function UpdateCommentModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      refreshCommentData(); // Làm mới dữ liệu trong Profile.jsx
      handleClose(); // Đóng modal

      // Gọi onUpdate với comment đã cập nhật
      const updatedComment = response.data; // Lấy bình luận đã cập nhật từ server
