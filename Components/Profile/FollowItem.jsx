...
const FollowItem = ({ item, handleClose }) => {
  ...
  const handleNavigate = () => {
    if (handleClose) handleClose(); // Đóng modal
    navigate(`/profile/${item.userId}`); // Điều hướng sang trang cá nhân
  };
  ...
  return (
    <div>
      <div className="flex space-x-5">
        ...
        />
        <div className="w-full mt-5 ml-2" onClick={handleNavigate}>
