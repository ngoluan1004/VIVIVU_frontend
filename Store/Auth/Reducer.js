import { GET_USER_PROFILE_FAILURE, GET_USER_PROFILE_REQUEST, GET_USER_PROFILE_SUCCESS, LOGIN_USER_FAILURE, LOGIN_USER_REQUEST, LOGIN_USER_SUCCESS, REGISTER_USER_FAILURE, REGISTER_USER_REQUEST, REGISTER_USER_SUCCESS,LOGOUT, FIND_USER_BY_ID_USER_SUCCESS, FOLLOW_USER_SUCCESS, UPDATE_USER_PROFILE_SUCCESS } from "./ActionType";
...
export const authReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case FIND_USER_BY_ID_USER_SUCCESS:
